...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Jul-2022 às 21:51
...
CREATE TABLE `clientes` (
  ...
  `nascimento` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(5, '2022_06_05_045207_create_planos_table', 1),
(6, '2022_06_06_091736_create_logins_table', 1),
(7, '2022_07_08_193151_clientes', 1),
(8, '2022_07_08_194906_cadastro', 1);
